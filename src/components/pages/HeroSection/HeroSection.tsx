    ...
    return (
        ...
        >
            ...
            <div className="flex gap-6 mt-8">
                <motion.button
                    className="bg-gradient-to-r from-[#6e07f3] to-[#9945ff] text-white px-8 py-4 rounded-xl hover:from-[#9945ff] hover:to-[#b366ff] transition-all duration-300 shadow-lg hover:shadow-[0_0_30px_rgba(110,7,243,0.4)] hover:scale-105 cursor-pointer"
                ...
                <motion.button
                    className="bg-gradient-to-r from-[rgba(110,7,243,0.2)] to-[rgba(153,69,255,0.1)] backdrop-blur-[20px] text-white px-8 py-4 rounded-xl border border-[rgba(255,255,255,0.2)] hover:border-[#6e07f3] hover:bg-gradient-to-r hover:from-[rgba(110,7,243,0.3)] hover:to-[rgba(153,69,255,0.2)] transition-all duration-300 hover:scale-105 cursor-pointer"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
